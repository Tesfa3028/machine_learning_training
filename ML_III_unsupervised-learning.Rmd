...
**Interpretation:** The mean absolute error for both models is almost the same  (0.06). However, for the reasons mentioned above the PCA model could be considered to be a better model in terms of fitting the data. 
...
*Note:* I have used copilot to understand the codes and explore the assignment. 
